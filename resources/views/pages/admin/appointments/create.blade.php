...
@section('content')
    <div class="admin-form-container">
        ...
        <form action="{{ route('admin.appointments.store') }}" method="POST" enctype="multipart/form-data" class="styled-form">
            @csrf
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="@error('time') is-invalid @enderror" id="timePicker"
                            placeholder="Válassz időpontot..." name="time" value="{{ old('time') }}" required>
                        @error('time')
                            <div class="alert alert-danger" style="margin-top:5px">{{ $message }}</div>
                        @enderror
                    </div>
